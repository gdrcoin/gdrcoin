...
unlocked to sign the Gdrcoin-Qt.app bundle.
...
allowing somebody to distribute a Gdrcoin-Qt.app or gdrcoin-qt-setup.exe with a valid
...
that the gdrcoin-qt.exe file inside the installer had not been tampered with.
