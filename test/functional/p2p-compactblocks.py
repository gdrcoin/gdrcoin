...
# TestNode: A peer we use to send messages to gdrcoind, and store responses.
...
class CompactBlocksTest(GdrcoinTestFramework):
    ...
    # This test actually causes gdrcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that gdrcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for gdrcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # gdrcoind will not send blocktxn responses for blocks whose height is
