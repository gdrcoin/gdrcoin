...
#ifndef GDRCOIN_TEST_SCRIPTNUM10_H
#define GDRCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Gdrcoin Core 0.10.0, for cross-comparison.
 */
public:
