 ...
 * between gdrcoind, and gdrcoin-qt and non-server tools.
*/
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), GDRCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://gitlab.com/gdrcoin/gdrcoin>";
    const std::string URL_WEBSITE = "<https://core.gdrcoin.org>";
...
/** Sanity checks
 *  Ensure that Gdrcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single Gdrcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", GDRCOIN_CONF_FILENAME)).string());
