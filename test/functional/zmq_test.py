...
from test_framework.test_framework import GdrcoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (GdrcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that gdrcoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("gdrcoind has not been built with zmq enabled.")
        ...
        ip_address = "tcp://127.0.0.1:21988"
