...
#if defined(NDEBUG)
# error "Gdrcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Gdrcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s MARK additional fees, %d delta bytes\n",
...
{
    // Gdrcoin: 100% of all coins are mined in the first block
    if (nHeight == 1)
