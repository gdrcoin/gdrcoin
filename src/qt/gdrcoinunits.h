...
#ifndef GDRCOIN_QT_GDRCOINUNITS_H
#define GDRCOIN_QT_GDRCOINUNITS_H
...
/** Gdrcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class GdrcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit GdrcoinUnits(QObject *parent);

    /** Gdrcoin units.
      @note Source: https://en.gdrcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        MARK,
...
typedef GdrcoinUnits::Unit GdrcoinUnit;

#endif // GDRCOIN_QT_GDRCOINUNITS_H
