...
This document provides guidelines for internationalization of the Gdrcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `gdrcoin_en.ts` remains unchanged.
