...
{
    BOOST_CHECK(TestSplitHost("www.gdrcoin.org", "www.gdrcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.gdrcoin.org]", "www.gdrcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.gdrcoin.org:80", "www.gdrcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.gdrcoin.org]:80", "www.gdrcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:1989", "127.0.0.1", 1989));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1989", "127.0.0.1", 1989));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1989", "::ffff:127.0.0.1", 1989));
    BOOST_CHECK(TestSplitHost("[::]:1989", "::", 1989));
    BOOST_CHECK(TestSplitHost("::1989", "::1989", -1));
    BOOST_CHECK(TestSplitHost(":1989", "", 1989));
    BOOST_CHECK(TestSplitHost("[]:1989", "", 1989));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1989", "127.0.0.1:1989"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1989", "[::]:1989"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
