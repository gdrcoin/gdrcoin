...
Below are some notes on how to build Gdrcoin Core for Windows.
...
way. This will install to `c:\workspace\gdrcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/gdrcoin
